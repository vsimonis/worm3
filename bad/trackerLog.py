...
#  logging.Logger.CAMERA = lambda inst, msg, *args, **kwargs: inst.log(logging.VERBOSE, msg, *args, **kwargs)
#  logging.camera = lambda msg, *args, **kwargs: logging.log(logging.CAMERA, msg, *args, **kwargs)
#
#  logging.POSITION = 6
#  logging.addLevelName(logging.POSITION, "POSITION")
#  logging.Logger.POSITION = lambda inst, msg, *args, **kwargs: inst.log(logging.POSITION, msg, *args, **kwargs)
#  logging.position = lambda msg, *args, **kwargs: logging.log(logging.CAMERA, msg, *args, **kwargs)
#  
#  logging.MOVER = 4
#  logging.addLevelName(logging.MOVER, "MOVER")
#  logging.Logger.MOVER = lambda inst, msg, *args, **kwargs: inst.log(logging.MOVER, msg, *args, **kwargs)
#  logging.mover = lambda msg, *args, **kwargs: logging.log(logging.MOVER, msg, *args, **kwargs)
# 
...
#  
 ...
 # print str(logging.Logger.getEffectiveLevel())
